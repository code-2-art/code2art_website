---
id: "tutorial-colab-huggingface-ai-221022-zh"
concept_id: "colab-huggingface-ai-221022"
type: "tutorial"
slug: "colab-huggingface-ai-221022"
title: "借助Colab从huggingface转存大模型文件到谷歌云盘 | AI课入门篇更新"
lang: "zh"
tags:
  - "colab"
  - "huggingface"
...
updated: "2022-10-22"
version: 1
summary: "很多开源AI模型现在托管在huggingface上，例如Stable Diffusion："
coverUrl: "/uploads/colab-huggingface-ai-221022/img_001.webp"
author: "Contra的后院"
publishedAt: "2022-10-22"
docUrl: "http://mp.weixin.qq.com/s?__biz=MzI1MTM0MDc5OA==&mid=2247487824&idx=1&sn=9a979eee7f78f8bcf3fd228078a3e92b&chksm=e9f523c1de82aad721cfedcafa79750a7c73694353b8075423d2190893f1f319eeae97b71e8b"
useDocUrl: false
---

很多开源AI模型现在托管在huggingface上，例如Stable Diffusion：

<img src="/uploads/colab-huggingface-ai-221022/img_001.webp" alt="" loading="lazy" />

在通过Colab使用SD时，需要加载这些模型。常见的做法有两个：

1. 每次都从huggingface下载（需要登录、输入token）。
2. 把大模型文件提前保存在Google Drive里，通过Colab直接挂载Drive即可，更加方便。

而例如SD1.5版的模型文件，完整版将近8g，从huggingface下载到本机、再上传到Google Drive是个办法，但可能会耗费一些时间和科学流量。

本课的方法是直接从huggingface转存大模型文件到Google Drive，无需经过本机电脑下载上传，方便Colab场景使用。

本课编入【AI艺术课-入门篇-Colab章】，并且作为公开教程开放：

<img src="/uploads/colab-huggingface-ai-221022/img_002.webp" alt="" loading="lazy" />

视频教程中的Colab notebook地址：

https://colab.research.google.com/drive/1I5\_jEf0Z2WDkZ3dhIaNEJ6xQV-TUCJKp?usp=sharing
...
<img src="/uploads/colab-huggingface-ai-221022/img_003.webp" alt="" loading="lazy" />
