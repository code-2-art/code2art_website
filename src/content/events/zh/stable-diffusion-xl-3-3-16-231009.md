---
id: "event-stable-diffusion-xl-3-3-16-231009-zh"
concept_id: "stable-diffusion-xl-3-3-16-231009"
type: "event"
slug: "stable-diffusion-xl-3-3-16-231009"
title: "Stable Diffusion XL模型训练(3) 数据集处理 | 训练营3期第16课"
lang: "zh"
tags:
  - "stable"
  - "diffusion"
...
updated: "2023-10-09"
version: 1
summary: "实验编程AI艺术训练营3期第16课："
coverUrl: "/uploads/stable-diffusion-xl-3-3-16-231009/img_001.webp"
author: "Contra的后院"
publishedAt: "2023-10-09"
event_date: "2023-10-09"
format: "online"
docUrl: "http://mp.weixin.qq.com/s?__biz=MzI1MTM0MDc5OA==&mid=2247490279&idx=1&sn=449e1c76000e5049cfac07c3ad77a1b5&chksm=e9f52876de82a16026f9c538753a69037acd86c9251d935886247411d818aefc4589fd7e0c40"
useDocUrl: false
---

<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_001.webp" alt="" loading="lazy" />
...
* **收集数据**（图片）。可以是公共数据，也可以来自爬虫抓取，或自己作品。入门篇有专门的爬虫案例课程。
* **处理数据**。缩放、裁切、调色、AI增强等。以前做StyleGAN训练，还需要数据“对齐”等规范化处理，有兴趣见入门篇相关课程。
* **数据标注**。写关键词/打标签。
...
**<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_002.webp" alt="" loading="lazy" />**
...
Stable Diffusion的训练对数据规范没有很严格。  
抓取和规范化处理见入门篇课程，部分插件和抓取脚本可能因为数据源头的限制而失效，教学思路不受影响。

<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_004.webp" alt="" loading="lazy" />

**详细数据处理步骤、关键词标注**

<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_005.webp" alt="" loading="lazy" />

详细完整步骤见训练营课程。含AI聊斋数据集标注示例。
...
* How to Create a LoRA Part 1: Dataset Preparation
  ...
  https://www.youtube.com/watch?v=N4\_-fB62Hwk
* ULTIMATE SDXL LORA Training!

  *SD XL角色训练及数据集处理。*

  https://youtu.be/N\_zhQSx2Q3c?si=PIroX-Kv0pSB3jhG&t=330
* SDXL LORA STYLE Training!

  *SD XL风格化训练及数据集处理。*

  https://youtu.be/1BCYdd9r1To?si=yyRzHmav7Mqh8s9F&t=119

<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_006.webp" alt="" loading="lazy" />
...
* 14 SD模型训练（1）基础介绍及工具安装
* 15 SD模型训练（2）SD XL LoRA训练
* 16 SD模型训练（3）数据集处理
...
<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_007.webp" alt="" loading="lazy" />
...
<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_008.webp" alt="" loading="lazy" />
...
<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_009.webp" alt="" loading="lazy" />
...
<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_010.webp" alt="" loading="lazy" />
...
<img src="/uploads/stable-diffusion-xl-3-3-16-231009/img_011.webp" alt="" loading="lazy" />
